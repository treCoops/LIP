...
public class BeveragesActivity extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.activity_beverages, container, false);
    ...
    void populateRecycleView(){
        FirebaseDatabase.getInstance().getReference().child("Beverage").addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
